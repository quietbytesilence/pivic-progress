...
A utilização de ferramentas de Inteligência Artificial na Educação é tema que vem sendo debatido por diversos estudiosos, principalmente no que tange aos geradores automáticos de texto - tecnologia transformer -, argumentando que tal tecnologia pode servir como auxiliar no mundo educacional, tanto de professores como de alunos
...
Sendo um ambiente notadamente voltado a conteúdos rápidos de baixa complexidade e alto tempo de tela, estudos têm correlacionado o uso/expansão das redes sociais com alterações prejudiciais em funções cognitivas como diminuição na habilidade de leitura, memória de longo prazo e atenção continuada (CARR, 2011). Há ainda pesquisas que indicam especificamente o uso dessas redes de hipermídia (ex: vídeos curtos, stories) com as alterações cognitivas (FIRTH et al., 2019).

Tendo implicações lógicas como a redução de tempo dedicado aos estudos e exposição prolongada a conteúdos superficiais, há ainda desdobramentos não visíveis em primeira análise, as implicações provindas da utilização em larga escala dessas tecnologias na formação intelectual (HAN, 2018).
